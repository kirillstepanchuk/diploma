...
import { approveProduct, deleteProduct } from "../store/actions/admin.actions";
...
const ProductTableRow: FC<UserTableRowProps> = ({ row }) => {
  ...
  return (
    ...
    >
      ...
      <TableCell align="right">
        <Button onClick={onApproveButtonClick} disabled={approveLoading || deleteLoading || isApproved || isDeleted}>
          {isApproved ? 'Опубликовано' : 'Опубликовать'}
        </Button>
      </TableCell>
      <TableCell align="right">
        <Button onClick={onDeleteButtonClick} disabled={approveLoading || deleteLoading || isApproved || isDeleted}>
